...
CRYPTO_SYMBOL = "MATIC-EUR"
CRYPTO_NAME = "MATIC"
CRYPTO_FULLNAME = "POLYGON"
CRYPTO_CURRENCY = "EUR"

# 2. Ειδική περίπτωση URL απο Binance
BINANCE_PAIR = "MATICEUR"
BINANCE_INTERVAL = "5m"
...
def save_state():
    state = {
        ...
        "active_trade": round(active_trade, 4) if active_trade is not None else 0,
        "trade_amount": trade_amount,
        "highest_price": round(highest_price, 4) if highest_price is not None else 0,
        ...
        if active_trade:
            ...
            if ENABLE_TRAILING_PROFIT:
                ...
                if trailing_profit_active:
                    ...
                    logging.info(f"Trailing sell price is {trailing_sell_price:.4f}")
                    ...
                    if current_price <= trailing_sell_price:
                        ...
                        logging.info(f"Trailing profit active. Current price {current_price} has not dropped below trailing sell price {trailing_sell_price:.4f}.")
